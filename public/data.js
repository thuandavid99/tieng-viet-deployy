...
const lessons = [
    ...
    { id: 46, char: "ac, ăc, âc", sub: "ac ăc âc", word: "mắc áo", svgKey: null, icon: "🧥", sentence: "Tây Bắc có ruộng bậc thang.", intro: "Bài 46. Vần ac, ặc, âc.", detail: "Học vần ac, ặc, âc.", guide_intro: "Luyện đọc.", guide_phoneme: "Ac, Ặc, Âc", examples: [{ word: "bác sĩ", icon: "👨‍⚕️" }, { word: "quả gấc", icon: "🍈" }], situation: null },
